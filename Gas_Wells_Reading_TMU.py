...
with col1:
 if st.button('Save New Reading'):
  ...
  try:           
   ...
   st.markdown("<span style="color: red;">text</span> <right>  <h1> Please, Update Reading Registeration Time OR Reading Number UP </h1> </font> </right> </h1> <span style="color: red;">text</span>",unsafe_allow_html=True)
